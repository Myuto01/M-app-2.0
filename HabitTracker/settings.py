...
ALLOWED_HOSTS = ["m-app-2-1.onrender.com", "127.0.0.1"]
...
MIDDLEWARE = [
    ...
    'Tracker.middleware.WebsiteBlockerMiddleware',
...
# Add or update the STATIC_ROOT setting to a valid filesystem path
